...
<Note>
  The API initiates calls asynchronously. Use webhooks or poll the [Get Conversation](/api-reference/public/get-conversation) endpoint with the conversation ID to track call status and retrieve transcripts after completion.
</Note>
