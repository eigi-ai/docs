...
api: "GET /v1/public/chat/sessions/{session_id}"
...
<ResponseField name="400 Bad Request">
  The specified session is not a chat session (e.g., it's a voice call).
  
  ```json
  {
    "detail": "Session is not a chat session"
  }
  ```
</ResponseField>
...
<ResponseField name="403 Forbidden">
  API key owner doesn't have access to this session.
...
<ResponseField name="404 Not Found">
  Session not found with the given ID.
