...
<Tip>
  If you are working with eigi.ai agents from the terminal, use the [eigi CLI
  guide](/cli/introduction) for installation, prompt retrieval, and the
  recommended pre-agent-creation workflow.
</Tip>
